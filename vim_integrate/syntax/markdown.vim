...
syn match markdownOutline1 /^}}}1/ conceal cchar=1
syn match markdownOutline2 /^}}}[0-9]/ conceal cchar=>
set conceallevel=2
...
hi def link markdownH1                    Folded
hi def link markdownH2                    Folded
hi def link markdownH3                    Folded
hi def link markdownH4                    Folded
hi def link markdownH5                    Folded
hi def link markdownH6                    Folded
...
hi def link markdownOutline1								Special
hi def link markdownOutline2							Special
