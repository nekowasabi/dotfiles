" close
nnoremap <silent><Leader>bc :lua require("toolwindow").close()<CR>

" toggle quickfix list (:copen)
nmap <silent><Leader>bq :lua require("toolwindow").open_window("quickfix", nil)<CR>

" use akinsho/nvim-toggleterm.lua
nnoremap <silent><Leader>bt :lua require("toolwindow").open_window("term", nil)<CR>

" use folke/trouble.nvim
nnoremap <silent><Leader>bd :lua require("toolwindow").open_window("trouble", nil)<CR>

" use folke/todo-comments.nvim
nnoremap <silent><Leader>bn :lua require("toolwindow").open_window("todo", nil)<CR>
