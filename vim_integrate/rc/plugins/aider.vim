...
let s:aider_settings = {
      ...
      \ 'architect_gemini': 'aider --no-auto-commits --chat-language ja --no-stream --architect --model gemini/gemini-2.0-flash-thinking-exp-1219 --editor-model gemini/gemini-2.0-flash-exp --cache-prompts --cache-keepalive-pings 6 --suggest-shell-commands',
