...
let s:aider_model_deepseek = ' --no-auto-commits --model my-openrouter/deepseek/deepseek-r1 --editor-model editor/anthropic/claude-3-7-sonnet-20250219 '
...
if g:IsMacNeovimInWork()
  ...
  let s:aider_settings = {
        \ 'architect_copilot': s:aider_base_command
        \ . s:aider_common_options
        \ . ' --architect '
        \ . s:aider_model_copilot
        \ ,
